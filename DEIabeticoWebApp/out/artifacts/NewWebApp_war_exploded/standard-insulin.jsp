...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                 <h1 class="page-header">Mealtime insulin dose - standard insulin sensitivity</h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
         ...
         <div class="container">
        <div class="col-md-4">
            <form class="form-group" action="StandardInsulin" method="post">
                <div class="form-group">
                    ...
                    <label>Individual sensitivity</label>
                    <input class="form-control" name="indSens" value="50">
