...
public class ObjectFactory {
    ...
    private final static QName _PersonalSensitivityToInsulin_QNAME = new QName("http://example/", "personalSensitivityToInsulin");
    private final static QName _BackgroundInsulinDose_QNAME = new QName("http://example/", "backgroundInsulinDose");
    private final static QName _BackgroundInsulinDoseResponse_QNAME = new QName("http://example/", "backgroundInsulinDoseResponse");
    private final static QName _InterruptedException_QNAME = new QName("http://example/", "InterruptedException");
    private final static QName _PersonalSensitivityToInsulinResponse_QNAME = new QName("http://example/", "personalSensitivityToInsulinResponse");
    private final static QName _MealtimeInsulinDoseResponse_QNAME = new QName("http://example/", "mealtimeInsulinDoseResponse");
    private final static QName _MealtimeInsulinDose_QNAME = new QName("http://example/", "mealtimeInsulinDose");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example/", name = "personalSensitivityToInsulin")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example/", name = "backgroundInsulinDose")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example/", name = "backgroundInsulinDoseResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example/", name = "InterruptedException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example/", name = "personalSensitivityToInsulinResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example/", name = "mealtimeInsulinDoseResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example/", name = "mealtimeInsulinDose")
