...
public interface Insulina {
    ...
    @Action(input = "http://example/Insulina/backgroundInsulinDoseRequest", output = "http://example/Insulina/backgroundInsulinDoseResponse", fault = {
        @FaultAction(className = InterruptedException_Exception.class, value = "http://example/Insulina/backgroundInsulinDose/Fault/InterruptedException")
    })
